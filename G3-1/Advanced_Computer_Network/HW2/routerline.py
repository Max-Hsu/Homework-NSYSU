...
from mininet.node import Node, OVSKernelSwitch, Controller, RemoteController ,OVSController
...
def main():
    ...
    net = Mininet(topo = rtopo, link=TCLink, autoSetMacs = True , controller = OVSController)
    net.start()
